    ...
    <div>
        <form id="form1" class="form-login" runat="server">
            ...
            <table class="auto-style1">
                ...
                <tr>
                <td colspan="2">
                    <asp:Label ID="lblLoginError" class="ilbLoginError login-error" runat="server" Text="Incorrect username or password. Please try again"></asp:Label>
                </td>
            </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    <td class="auto-style7">
                        <asp:TextBox ID="txtUserError" runat="server" CssClass="auto-style3" Width="324px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style10">
                        <asp:TextBox ID="txtPasswordError" type="password" runat="server" CssClass="auto-style5" Height="30px"  Width="324px"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <div class="btn-signin">
                <asp:Button ID="btnLoginError" type="button" class="btn btn-success signin" runat="server" Text="SIGN IN" OnClick="btnLoginError_Click" Width="118px" Height="42px"/>
            </div>
        </form>
    </div>
</body>
